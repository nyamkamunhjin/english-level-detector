        ...
        {isBalanced ? (
          <ReactMarkdown
            components={{
              ...
              pre: ({ node, ...props }) => (
                <pre className="whitespace-pre-wrap overflow-x-auto p-4 bg-gray-100 rounded-md" {...props} />
              ),
              code: ({ node, ...props }) => (
                <code className="text-red-600 font-semibold text-sm" {...props} />
              ),
              ul: ({ node, ...props }) => (
              ...
              blockquote: ({ node, ...props }) => (
                <blockquote className="italic border-l-4 border-gray-200 pl-4" {...props} />
              ),
              h1: ({ node, ...props }) => (
